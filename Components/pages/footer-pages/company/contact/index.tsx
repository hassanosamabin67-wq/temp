    ...
    <>
      <div className="contact-container">
        ...
        <div className="hero-section">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              We’re here to assist you. Reach out and let’s connect!
            </p>
        ...
        <div className="contact-section">
          ...
          <div className="contact-grid">
            <div className="contact-card">
              ...
              <p>
                Email:{" "}
                <a href="mailto:info@kaboomcollab.com">info@kaboomcollab.com</a>
              </p>
            </div>
            {/* <div className="contact-card">
          ...
          <div className="contact-card">
            ...
            <div className="contact-card">
              ...
              <p>
                Email:{" "}
                <a href="mailto:partnerships@kaboomcollab.com">
                  partnerships@kaboomcollab.com
                </a>
              </p>
            </div>
          </div>
        ...
        <div className="stay-connected">
          ...
          <p>
            Follow us on social media for the latest updates and creative
            inspiration.
          </p>
          <div className="ctc-social-icons">
            ...
            <div className="ctc-icon">
              <a className="ctc-ins-icon-parent" href="https://www.instagram.com/kaboom_collab" target="_blank" rel="noopener noreferrer">
                <InstagramIcon />
              </a>
            </div>
            <div className="ctc-icon">
              <a href="https://www.youtube.com/@kaboomcollab4893" target="_blank" rel="noopener noreferrer">
                <FaYoutube className="ctc-youtube-icon" />
              </a>
            </div>
          </div>
        </div>
      ...
      <CustomGetStarted
        ctabtn="Contact Us"
        description="Thank you for being part of the Kaboom Collab community. Don’t hesitate to reach out—we look forward to connecting with you!"
